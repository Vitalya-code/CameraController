...
from PyQt6.QtWidgets import QWidget, QFileDialog, QPushButton, QGridLayout, QHBoxLayout, QLabel, QLineEdit, QCheckBox, \
...
class Main(QWidget):
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QIcon('bin/ico.ico'))
        ...
        self.lay.setAlignment(Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.AlignTop)

        # add widgets
        self.topLayout.addWidget(self.browseBtn)
        self.topLayout.addWidget(self.label)
        self.topLayout.addWidget(self.checkBox, Qt.AlignmentFlag.AlignLeft)
        # topLayout.addWidget(searchLabel,Qt.AlignRight)

        self.topLayout.addWidget(self.searchInput, Qt.AlignmentFlag.AlignRight)
